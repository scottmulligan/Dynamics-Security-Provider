namespace CRMSecurityProvider.Repository.V4
{
  ...
  using System.Linq;
  using CRMSecurityProvider.Sources.Repository.V4;
  ...
  /// <summary>
  /// Role repository class (API v4).
  /// </summary>
  public class RoleRepositoryV4 : RoleRepositoryBase
  {
    /// <summary>
    ...
    /// </summary>
    protected IMarketingListToRoleConverterV4 MarketingListToRoleConverter { get; private set; }
